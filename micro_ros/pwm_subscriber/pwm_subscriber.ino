...
void setup() {
  set_microros_wifi_transports("qwertyuiop", "12345678", "192.168.81.147", 8888);
  Serial.begin(9600);
...
void loop() {
  ...
  analogWrite(motor1, (floor(msg.linear.x)) - 125);
  digitalWrite(DIR1, HIGH);
  Serial.println(floor(msg.linear.x)); 

  Serial.print("Left-Velocity: ");
  analogWrite(motor2, (floor(msg.linear.y) - 125));
