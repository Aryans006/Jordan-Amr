...
def generate_launch_description():	
	...
	pkg_amr_desc = get_package_share_directory('jordan_description')
	xacro_path = pkg_amr_desc + '/urdf/jordan.xacro'
	
	# TODO: take rviz config file as launch arg 
	# use this one as default
	rviz_config = pkg_amr_desc + '/config/urdf.rviz'
	...
	state_publisher = Node(package = 'robot_state_publisher',
								...
								parameters = [{'robot_description': ParameterValue(Command( \
											['xacro ', os.path.join(pkg_amr_desc, 'urdf/jordan.xacro'),
